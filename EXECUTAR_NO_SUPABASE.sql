-- ========================================
-- PASSO 1: ATUALIZAR CONSTRAINT DE WORKSPACES
-- ========================================
-- Copie e execute este comando primeiro no SQL Editor do Supabase
...
-- ========================================
-- PASSO 2: CRIAR TABELAS DO PLANNER
-- ========================================
-- Depois execute estes comandos:

-- Criar tabela de categorias do planner
...
-- Criar tabela de tarefas do planner
...
-- ========================================
-- Por último, execute estes comandos para melhorar a performance:
...
-- PRONTO! 
-- ========================================
-- Agora você pode criar workspaces do tipo "planner" no app!
